...
<h4>어떻게 동작하나요</h4>
<ul>
  <li>원본은 Drive의 <code>NAIS3</code> 폴더에 월별로 정리되어 업로드됩니다.</li>
  ...
  <li>오프라인이거나 업로드가 실패해도 <b>생성은 성공</b>합니다. 대기열에 쌓아 두었다가 온라인이 되면 자동으로 업로드합니다.</li>
</ul>

<h4>권한 · 개인정보</h4>
<ul>
  <li>권한 범위는 <code>drive.file</code> 하나입니다. <b>이 앱이 만든 파일만</b> 접근하며, Drive의 다른 파일은 보이지 않습니다.</li>
  <li>로그인 토큰 자체는 저장되지 않습니다. 다음 방문 때 <b>자동 재연결</b>을 시도하며, 동의가 만료됐거나 브라우저가 막으면 패널에서 다시 연결하면 됩니다.</li>
</ul>
